...
// ============================================
// PERSPECTIVE & ROTATION SYSTEM - FIXED
// ============================================

const getPerspectiveOffset = (myColor) => {
  const colorMap = {
    'BLUE': 0,
    'RED': 2,
    'GREEN': 1,
...
const getTransformedCellCoordinates = (row, col, myColor) => {
  const offset = getPerspectiveOffset(myColor);
  let r = row;
  let c = col;
...
export default function App() {
  ...
  // ============================================
  // FIX: JOIN ONLINE ROOM - DYNAMIC COLOR ASSIGNMENT
  // ============================================
    ...
    tempWs.onmessage = (e) => {
      try {
        ...
        if (message.event === 'broadcast' && message.payload?.type === 'ROOM_EXISTS_CONFIRMED') {
          ...
          // DYNAMIC COLOR ASSIGNMENT - FIXED
          const availableColors = data.activeColors.filter(c => !data.syncedRoomPlayers?.[c]);
  ...
  // ============================================
  // RENDER ALL TOKENS - FIXED PERSPECTIVE
  // ============================================
  ...
  // ============================================
  // GAME BOARD VIEW - FIXED PERSPECTIVE
  // ============================================
