...
export default function App() {
  ...
  return (
    <SafeAreaView style={styles.mainContainer}>
      ...
      {/* 30-SECOND TIMER BETWEEN CARDS AND BOARD */}
      <View style={[styles.centerBoardTimerWrap, turnTimeLeft <= 10 && styles.timerDangerPulse]}>
        <Text style={styles.centerBoardTimerText}>⏱️ Turn Time Left: {turnTimeLeft}s</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  centerBoardTimerWrap: { backgroundColor: 'rgba(15, 23, 42, 0.9)', paddingHorizontal: 16, paddingVertical: 4, borderRadius: 12, borderWidth: 1.5, borderColor: '#38bdf8', marginVertical: 4, elevation: 4 },
  centerBoardTimerText: { color: '#ffffff', fontWeight: '900', fontSize: 12, letterSpacing: 0.5 },
