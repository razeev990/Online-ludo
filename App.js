      ...
      if (pairs && Array.isArray(pairs)) {
        ...
        if (usersData && Array.isArray(usersData)) {
          ...
          const list = usersData.map(u => {
            ...
            // Time window badha kar 5 minutes (300000 ms) kar diya gaya hai taaki offline status ka issue na aaye
    ...
    return (
      <View style={styles.dashboardContainer}>
        ...
        <SafeAreaView style={styles.topHeaderContainer}>
          ...
          >
            <View style={styles.smallCrownBadge}>
        ...
        {/* Center Banner Profile Section */}
        <View style={styles.centerBannerProfileWrap}>
          <View style={styles.centerCrownPosition}>
            <Text style={{ fontSize: 28 }}>👑</Text>
          </View>
          <View style={styles.centerBannerContainer}>
...
const styles = StyleSheet.create({
  ...
  // Fixed and Balanced Top Header
  topHeaderContainer: { width: '100%', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 12, paddingTop: 10, zIndex: 30 },
  topLeftProfileWrap: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(15, 23, 42, 0.85)', borderWidth: 1, borderColor: '#facc15', borderRadius: 12, paddingHorizontal: 8, paddingVertical: 4, maxWidth: '45%' },
  smallCrownBadge: { width: 24, height: 24, borderRadius: 12, backgroundColor: 'rgba(250, 204, 21, 0.2)', justifyContent: 'center', alignItems: 'center', marginRight: 6 },
  headerTextCol: { justifyContent: 'center' },
  headerUserName: { color: '#ffffff', fontSize: 12, fontWeight: '900', maxWidth: 90 },
  headerUserCoins: { color: '#facc15', fontSize: 10, fontWeight: '800', marginTop: 1 },
  ...
  // Centered Banner Profile Section
  centerBannerProfileWrap: { width: '100%', alignItems: 'center', marginTop: 4, zIndex: 15 },
  centerCrownPosition: { marginBottom: -12, zIndex: 5, alignItems: 'center' },
  centerBannerContainer: { width: '82%', backgroundColor: 'rgba(30, 41, 59, 0.85)', borderWidth: 2, borderColor: '#facc15', borderRadius: 16, paddingVertical: 6, paddingHorizontal: 12, alignItems: 'center', shadowColor: '#facc15', shadowOpacity: 0.3, shadowRadius: 6, elevation: 5 },
