    ...
    return (
      <View style={styles.cardContainerWrapper}>
        ...
        >
          ...
          {isCurrent && (
            <View style={[styles.cardInlineTimerBadge, turnTimeLeft <= 10 && styles.timerDangerPulse]}>
              <Text style={styles.cardInlineTimerText}>⏱️ {turnTimeLeft}s</Text>
            </View>
          )}
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  cardInlineTimerBadge: { position: 'absolute', bottom: -12, alignSelf: 'center', backgroundColor: '#0f172a', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, borderWidth: 1.5, borderColor: '#38bdf8', zIndex: 35 },
  cardInlineTimerText: { color: '#ffffff', fontWeight: '900', fontSize: 10 },
