...
export default function App() {
  ...
  // Dynamic Perspective Layout Mapping for 4 player seats based on myColor
  const getPerspectiveLayout = () => {
    // Default (Blue bottom, Green top, Red left, Yellow right)
  ...
  const perspective = getPerspectiveLayout();
