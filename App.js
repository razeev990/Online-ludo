...
export default function App() {
  ...
  // Standard fixed board perspective
...
const styles = StyleSheet.create({
  ...
  centerTriangleBottom: { position: 'absolute', bottom: 0, left: 0, width: 0, height: 0, borderLeftWidth: (CELL_SIZE * 3) / 2, borderRightWidth: (CELL_SIZE * 3) / 2, borderBottomWidth: (CELL_SIZE * 3) / 2, borderLeftWidth: 'transparent', borderRightColor: 'transparent', borderBottomColor: '#2563eb' },
