...
const styles = StyleSheet.create({
  ...
  topHeaderOverlay: { position: 'absolute', top: 18, left: 8, right: 8, height: 60, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', zIndex: 30 },
  
  topLeftProfileWrap: { marginLeft: 38, paddingVertical: 2, justifyContent: 'center' },
