...
export default function App() {
  ...
  // Fixed Board Flip: Host (BLUE) ke liye board seedha rahega, aur joining player (GREEN/YELLOW) ke liye board automatic 180° flip ho jayega.
  const shouldFlipBoard = (gameMode === 'ONLINE' || gameMode === 'HYBRID') && (myColor === 'GREEN' || myColor === 'YELLOW');
