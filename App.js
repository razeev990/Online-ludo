...
// --- CENTRAL PERSPECTIVE ENGINE ---
const getPerspectiveOffset = (color) => {
  switch (color) {
    case 'RED': return 2;    // 180 deg
    case 'GREEN': return 1;  // 90 deg clockwise
    case 'YELLOW': return 3; // 270 deg clockwise (-90)
    case 'BLUE':
    default:
      return 0;              // 0 deg
  }
...
// Unified Central Slot Mapping for 4 Seats based on active player's color
