...
export default function App() {
  ...
  // DASHBOARD VIEW (Updated with Fulfilled Top Action Row & Lowered Center Banner)
  if (!gameMode) {
    ...
    return (
      <View style={styles.dashboardContainer}>
        ...
        {/* 1. FULFILLED TOP BOX: Friends, Daily Bonus, Leaderboard, & Settings */}
        <SafeAreaView style={styles.fulfilledTopActionCenterBar}>
          <View style={styles.topActionCenterInnerRow}>
            {lastBonusClaimDate !== new Date().toDateString() && (
              <TouchableOpacity activeOpacity={0.85} style={styles.megaFulfilledButton} onPress={claimFreeBonus}>
                <Text style={styles.megaFulfilledEmoji}>🎁</Text>
                <Text style={styles.megaFulfilledText}>Daily Bonus</Text>
              </TouchableOpacity>
            )}
        ...
        {/* 2. CENTER BANNER PROFILE SECTION (Lowered & Fitted into Background Box) */}
        <View style={styles.centerBannerProfileWrapLowered}>
          <TouchableOpacity activeOpacity={0.85} onPress={() => setProfileStatsModal(true)} style={styles.centerCrownPosition}>
            <Text style={{ fontSize: 32 }}>👑</Text>
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={0.85} onPress={() => setProfileStatsModal(true)} style={styles.centerBannerContainerLowered}>
...
const styles = StyleSheet.create({
  ...
  // Fulfilled Top Box Styles
  fulfilledTopActionCenterBar: { width: '100%', alignItems: 'center', paddingTop: 14, zIndex: 30 },
  topActionCenterInnerRow: { width: '92%', flexDirection: 'row', justifyContent: 'space-between', backgroundColor: 'rgba(15, 23, 42, 0.9)', borderWidth: 1.5, borderColor: '#facc15', borderRadius: 16, paddingVertical: 10, paddingHorizontal: 8, elevation: 8 },
  megaFulfilledButton: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#1e293b', marginHorizontal: 3, paddingVertical: 8, borderRadius: 10, borderWidth: 1, borderColor: '#334155', position: 'relative' },
  megaFulfilledEmoji: { fontSize: 20, marginBottom: 2 },
  ...
  // Lowered & Fitted Center Banner Styles
  centerBannerProfileWrapLowered: { width: '100%', alignItems: 'center', marginTop: 18, zIndex: 15 },
  centerCrownPosition: { marginBottom: -14, zIndex: 5, alignItems: 'center' },
  centerBannerContainerLowered: { width: '84%', backgroundColor: 'rgba(30, 41, 59, 0.92)', borderWidth: 2.5, borderColor: '#facc15', borderRadius: 18, paddingVertical: 8, paddingHorizontal: 14, alignItems: 'center', shadowColor: '#facc15', shadowOpacity: 0.4, shadowRadius: 8, elevation: 8 },
