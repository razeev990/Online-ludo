...
const styles = StyleSheet.create({
  ...
  topHeaderOverlay: { position: 'absolute', top: height > 700 ? 38 : 20, left: 8, right: 8, height: 60, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', zIndex: 30 },
  
  topLeftProfileWrap: { marginLeft: 45, paddingVertical: 2, justifyContent: 'center' },
  ...
  centerCrownPlankWrap: { position: 'absolute', top: height > 700 ? '19%' : '17%', alignSelf: 'center', alignItems: 'center', zIndex: 20 },
  ...
  profileBigAvatarWrap: { width: 75, height: 75, borderRadius: 38, backgroundColor: '#1e3a8a', justifyContent: 'center', alignItems: 'center', borderWidth: 2.5, borderColor: '#facc15', marginVertical: 6, position: 'relative' },
  ...
  avatarPickerTriggerBtn: { marginTop: 10, backgroundColor: '#1e3a8a', paddingVertical: 8, paddingHorizontal: 12, borderRadius: 10, borderWidth: 1, borderColor: '#facc15', width: '100%', alignItems: 'center' },
