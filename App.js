...
export default function App() {
  ...
  // Redesigned Attractive Friends Squad Modal with Real-time Online/Offline Status Indicator
    ...
    <Modal transparent animationType="slide" visible={friendsModal}>
      <View style={styles.inviteModalOverlay}>
        <View style={[styles.glassCard, { maxHeight: '92%', padding: 14 }]}>
          ...
          {/* Friends List Tab with Real-time Online Status */}
          {friendsTab === 'LIST' && (
                  ...
                  <View key={friend.id} style={styles.friendItemCardWrap}>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                      ...
                      <View style={{ marginLeft: 10 }}>
                        ...
                        <Text style={[styles.friendCardSubText, { color: friend.online ? '#4ade80' : '#94a3b8' }]}>
