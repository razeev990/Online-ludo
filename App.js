...
export default function App() {
  ...
  const acceptFriendRequest = async (reqUser) => {
    try {
      ...
      // Auto-Mutual Friendship Insert for Both Users
  ...
  if (!gameMode) {
    ...
    return (
      <View style={styles.dashboardContainer}>
          ...
          <Modal transparent animationType="slide" visible={leaderboardModal}>
            <View style={styles.inviteModalOverlay}>
              <View style={[styles.glassCard, { borderColor: '#facc15', borderWidth: 2 }]}>
                ...
                <Text style={styles.podiumSubHeader}>Top Royale Champions</Text>

                <View style={styles.leaderboardListWrap}>
                  <View style={[styles.leaderboardRowItem, styles.leaderboardHostRow]}>
                    <Text style={styles.rankBadgeText}>🥇 1st</Text>
                    <Text style={[styles.rankPlayerName, { color: '#facc15' }]}>{currentUser.name} (You)</Text>
                    <Text style={styles.rankCoinText}>🪙 {currentUser.coins.toLocaleString()}</Text>
                  </View>
                  <View style={styles.leaderboardRowItem}>
                    <Text style={styles.rankBadgeText}>🥈 2nd</Text>
                    <Text style={styles.rankPlayerName}>Vikram King</Text>
                    <Text style={styles.rankCoinText}>🪙 8,500</Text>
                  </View>
                  <View style={styles.leaderboardRowItem}>
                    <Text style={styles.rankBadgeText}>🥉 3rd</Text>
                    <Text style={styles.rankPlayerName}>Aryan Pro</Text>
                    <Text style={styles.rankCoinText}>🪙 6,200</Text>
                  </View>
                </View>
        ...
        {/* Compact Top Header with Safe Friends Button Padding */}
        <SafeAreaView style={styles.topHeaderOverlay}>
          ...
          <View style={styles.topRightBtnsWrap}>
            ...
            {/* Universal Activity Red Indicator on Friends Button */}
